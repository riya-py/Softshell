const features = [
  { 
    ...
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" className="h-10 w-10 mb-4 text-indigo-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
      ...
      <div className="max-w-6xl mx-auto relative z-10">
        ...
        <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
          {features.map((f, i) => (
            <div 
              key={i} 
              className="bg-gray-800/50 backdrop-blur-sm p-8 rounded-xl border border-gray-700 hover:border-indigo-500/30 transition-all duration-300 flex flex-col items-center text-center transform hover:-translate-y-1 group"
            >
              <div className="p-4 bg-indigo-900/50 rounded-full mb-4">
                {f.icon}
              </div>
